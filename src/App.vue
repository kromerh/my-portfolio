      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="education">
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            <div class="resume-content mr-auto">
              <h3 class="mb-0">Laboratory of Nuclear Energy Systems, ETH Zürich, Switzerland</h3>
              <div class="subheading mb-3">Doctoral Student in Nuclear Engineering</div>
              <p>Thesis title: "Optimization of a compact deuterium-deuterium fast neutron generator for imaging applications."</p>
    ...
    return {
      ...
      experience: [
        ...
        },
        {
          ...
          description: 'I was serving as Vice President of Technology and Head of Data Analytics at Telejob. Telejob is a non-profit organization of ETH Zürich, which aims to reach and connect students and employers - companies as well as universities - in Switzerland. Telejob is run mainly by student volunteers.',
          items: [
            ...
            'Helped in the successful start of the first Poly-E-Fair, a virtual career fair, at ETH Zürich',
        ...
        },
        {
          ...
          items: [
            ...
            'Evaluated probabilistic neutron transport calculations using MCNP6 and post-processed them in Python',
